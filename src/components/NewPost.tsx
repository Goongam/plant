  ...
  return (
    <section className="w-full flex-col items-center">
      ...
      >
        ...
        <label
          htmlFor="input-form"
          className="flex justify-center items-center w-full h-52 bg-slate-100 max-w-3xl"
        ...
        <div className="w-full grid grid-cols-5 max-w-3xl">
        ...
        <textarea
          className="w-full h-52 max-w-3xl mt-4 border border-black rounded-md"
          ref={commentRef}
          placeholder="코멘트 작성..."
          required
        />
        <button className="w-full h-10 max-w-3xl bg-green-400 text-white font-bold mt-4 rounded-lg">
          업로드
        </button>
      </form>
    </section>
